...
### Yazi File Manager
- `ya pkg install` - Install yazi plugins from package.toml
- `ya pkg upgrade` - Update yazi plugins
- Configuration includes custom themes (flexoki-dark) and plugins (glow, jump-to-char, mount)
...
- **nvim/** - Neovim configuration using LazyVim framework with custom plugins and LSP setup
...
- **Plugin ecosystems**:
  - Neovim: LazyVim + custom plugins via Lazy
